...
#' @param primary_input_entities List of variables that MUST be part of the combinations identified by the method
...
compare_enrichment_modifiers <- function(boolean_input_df, combo_length, min_indv_threshold, max_freq_threshold, primary_input_entities,
  ...
  input_colname_only_list <- setdiff(sel_input_colname_list, primary_input_entities)
  primary_input_list <- intersect(sel_input_colname_list, primary_input_entities)
  ...
  case_freqitems_df <- run_apriori_rules_modifiers(apriori_input_cases_df, combo_length, support_threshold,
                                                      input_colname_only_list, output_colname_list = primary_input_list)
  ...
  sel_uniq_combo_items <- setdiff(uniq_combo_items, primary_input_list)
  sel_primary_input_list <- intersect(uniq_combo_items, primary_input_list)
  cont_freqitems_df <- run_apriori_rules_modifiers(apriori_input_controls_df, combo_length, support_threshold,
                                                      sel_uniq_combo_items, output_colname_list = sel_primary_input_list)
  ...
  if (multtest_sig_comb_count > 0) {
    ...
    if (zero_freq_combo_count > 0) {
      ...
      #######################################################################################################
      support_threshold = 0
      sel_case_uniq_sig_items <- setdiff(case_uniq_sig_items, primary_input_list)
      sel_primary_input_list <- intersect(case_uniq_sig_items, primary_input_list)

      refine_freqitems_df <- run_apriori_rules_modifiers(apriori_input_controls_df, combo_length, support_threshold,
                                                            sel_case_uniq_sig_items, output_colname_list = sel_primary_input_list)
